...
- (id)initWithHeaderTitle:(NSString *)headerTitle
    ...
    if(self){
        ...
        self.headerBackgroundColor = [UIColor colorWithRed:224.0/255 green:108.0/255 blue:121.0/255 alpha:1];
        
        // footer button
        self.confirmButtonTitle = confirmButtonTitle ? confirmButtonTitle: @"";
        self.confirmButtonNormalColor = [UIColor blackColor];
        self.confirmButtonHighlightedColor = [UIColor grayColor];
    
        self.confirmButtonBackgroundColor = [UIColor colorWithRed:204.0/255 green:204.0/255 blue:204.0/255 alpha:1];
        ...
        self.cancelButtonBackgroundColor = [UIColor colorWithRed:97.0/255 green:97.0/255 blue:97.0/255 alpha:1];
